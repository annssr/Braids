...
PImage studentFace1; // picture of author's face, should be: data/pic.jpg in sketch folder
PImage studentFace2; // picture of author's face, should be: data/pic.jpg in sketch folder
PImage studentFace3; // picture of author's face, should be: data/pic.jpg in sketch folder
/* End Ruth */
